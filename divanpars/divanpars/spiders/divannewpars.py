...
class DivannewparsSpider(scrapy.Spider):
    # Указываем имя паука (spider).
    # Это имя будет использоваться для запуска этого паука.
    name = "divannewpars"

    # Указываем домены, которые этот паук может посещать.
    # Это предотвращает случайный переход на другие сайты.
    allowed_domains = ["https://divan.ru"]

    # Указываем начальные URL, с которых паук начнет свою работу.
    ...
    def parse(self, response):
        ...
        for divan in divans:
            ...
            yield {
                ...
                # Создаём словарик цен, используем поиск по диву,
                # а внутри дива — по тегу span
